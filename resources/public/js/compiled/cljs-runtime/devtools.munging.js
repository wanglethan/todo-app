...
var temp__5733__auto____$1 = (o26952["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o26953 = temp__5733__auto____$1;
return (o26953["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26598__auto__ = f;
return (o__26598__auto__["toString"]).call(o__26598__auto__);
} else {
return "";
}
}catch (e26954){var _ = e26954;
return "";
}});
...
try{var o__26598__auto___27164 = t;
(o__26598__auto___27164["cljs$lang$ctorPrWriter"]).call(o__26598__auto___27164,t,writer);
}catch (e26957){var __27165 = e26957;
}
...
var char_code = (function (){var o__26598__auto__ = (new String(char$));
return (o__26598__auto__["charCodeAt"]).call(o__26598__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26598__auto__ = String;
return (o__26598__auto__["fromCharCode"]).call(o__26598__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26963 = num_code;
switch (G__26963) {
case (1):
return (185);
...
var o__26598__auto__ = String;
return (o__26598__auto__["fromCharCode"]).call(o__26598__auto__,superscript_code);
});
/**
...
}catch (e26972){var _e__26633__auto__ = e26972;
return false;
}})())){
...
var vec__26973 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26973,(0),null);
...
var len__4771__auto___27179 = arguments.length;
var i__4772__auto___27180 = (0);
while(true){
if((i__4772__auto___27180 < len__4771__auto___27179)){
args__4777__auto__.push((arguments[i__4772__auto___27180]));

var G__27182 = (i__4772__auto___27180 + (1));
i__4772__auto___27180 = G__27182;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26987){
var vec__26988 = p__26987;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26988,(0),null);
...
var G__27187 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27188 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27187;
remaining_tokens = G__27188;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26984){
var G__26985 = cljs.core.first(seq26984);
var seq26984__$1 = cljs.core.next(seq26984);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26985,seq26984__$1);
}));
...
var vec__26993 = cljs.core.split_with((function (p1__26992_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__26992_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26993,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26993,(1),null);
...
var vec__26999 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26999,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26999,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27191 = cljs.core.rest(remaining_tokens);
var G__27192 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27191;
name_tokens = G__27192;
continue;
} else {
...
var vec__27005 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27005,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27005,(1),null);
var vec__27008 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27008,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27008,(1),null);
var vec__27011 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27011,(3),null);
...
var vec__27018 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27018,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27018,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27018,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27018,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27018,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27018,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27022 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27022,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27022,(1),null);
var vec__27025 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27025,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27025,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27031 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27031) : devtools.munging.parse_fn_info_deep.call(null,G__27031));
})()));
}
} else {
return fn_info;
...
var G__27209 = (arity + (1));
var G__27210 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27043){
var vec__27044 = p__27043;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27044,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27044,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27052_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27052_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27053_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27053_SHARP_);
}),sorted_infos);
...
var args__4777__auto__ = [];
var len__4771__auto___27217 = arguments.length;
var i__4772__auto___27218 = (0);
while(true){
if((i__4772__auto___27218 < len__4771__auto___27217)){
args__4777__auto__.push((arguments[i__4772__auto___27218]));

var G__27219 = (i__4772__auto___27218 + (1));
i__4772__auto___27218 = G__27219;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27057){
var vec__27058 = p__27057;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27058,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27054){
var G__27055 = cljs.core.first(seq27054);
var seq27054__$1 = cljs.core.next(seq27054);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27055,seq27054__$1);
}));
...
var map__27070 = options;
var map__27070__$1 = cljs.core.__destructure_map(map__27070);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27070__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27070__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27070__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27070__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27071 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27071,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27071,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27071,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27071,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27071,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27071,(5),null);
...
var o__26598__auto__ = f;
return (o__26598__auto__["getBasis"]).call(o__26598__auto__);
});
/**
...
}catch (e27078){var _e__26633__auto__ = e27078;
...
var G__27231 = (obj[cljs.core.first(path)]);
var G__27232 = cljs.core.rest(path);
obj = G__27231;
path = G__27232;
continue;
} else {
...
var _STAR_ = (function (accum,p__27099){
var vec__27100 = p__27099;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27100,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27100,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27105){
var vec__27106 = p__27105;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27106,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27106,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27106,(2),null);
...
var post_process = (function (p__27141){
var vec__27142 = p__27141;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27142,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27142,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27136_SHARP_){
return (obj[cljs.core.first(p1__27136_SHARP_)]);
}),sorted_matches);
