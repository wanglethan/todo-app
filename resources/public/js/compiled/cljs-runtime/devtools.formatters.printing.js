...
var len__4771__auto___27295 = arguments.length;
var i__4772__auto___27296 = (0);
while(true){
if((i__4772__auto___27296 < len__4771__auto___27295)){
args__4777__auto__.push((arguments[i__4772__auto___27296]));

var G__27297 = (i__4772__auto___27296 + (1));
i__4772__auto___27296 = G__27297;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27234){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27235,G__27236,seq27234__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27248_SHARP_){
return (!((cljs.core.meta(p1__27248_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27273__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27276){var _e__26633__auto__ = e27276;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e27281){var _e__26633__auto__ = e27281;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27283 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27284 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27284);

try{var map__27285 = opts;
var map__27285__$1 = cljs.core.__destructure_map(map__27285);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27285__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27283);
}});
...
var temp__5733__auto___27308 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___27308)){
var managed_print_level_27309 = temp__5733__auto___27308;
var _STAR_print_level_STAR__orig_val__27290_27310 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27291_27311 = managed_print_level_27309;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27291_27311);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27286_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27286_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27290_27310);
}} else {
job_fn();
}
