...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31945 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31945(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_31946 = (function (runtime,key,spec){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_31946(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_31947 = (function (runtime,key){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_31947(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_31951 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_31951(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31969 = (function (runtime,input,callback){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31969(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31976 = (function (runtime,code){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31976(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__31941,callback){
var map__31942 = p__31941;
var map__31942__$1 = cljs.core.__destructure_map(map__31942);
var input = map__31942__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31942__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31942__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
