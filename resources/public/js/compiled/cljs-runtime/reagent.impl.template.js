...
var G__37324 = o;
goog.object.set(G__37324,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__37328 = o;
goog.object.set(G__37328,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__37332 = props;
var G__37332__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37332,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37332);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37332__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4160__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37333 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37333,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37333;
}
})(),id_class);
...
var G__37334 = (cljs.core.count(argv) - first_child);
switch (G__37334) {
case (0):
...
return cljs.core._write(writer__4405__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__37335 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37335,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37335,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37335,(2),null);
...
var temp__5739__auto___37377 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___37377 == null)){
} else {
var key_37380 = temp__5739__auto___37377;
(jsprops.key = key_37380);
}
...
var temp__5739__auto___37382 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___37382 == null)){
} else {
var key_37383 = temp__5739__auto___37382;
(jsprops.key = key_37383);
}
...
var jsprops = (function (){var or__4160__auto__ = reagent.impl.template.convert_prop_value(((hasprops)?props:null));
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
return ({});
...
var temp__5739__auto___37388 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___37388 == null)){
} else {
var key_37391 = temp__5739__auto___37388;
(jsprops.key = key_37391);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_(props)));
var jsprops = (function (){var or__4160__auto__ = reagent.impl.template.convert_props(((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
return ({});
...
var temp__5739__auto___37401 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___37401 == null)){
} else {
var key_37403 = temp__5739__auto___37401;
(jsprops.key = key_37403);
}
...
var temp__5739__auto___37415 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___37415 == null)){
} else {
var key_37416 = temp__5739__auto___37415;
(jsprops.key = key_37416);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37344_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37344_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37345 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37345,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37345,(1),null);
...
break;
default:
var G__37421 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37422 = compiler;
v = G__37421;
compiler = G__37422;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37354 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37354 = (function (opts,id,fn_to_element,meta37355){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37354.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37356,meta37355__$1){
var self__ = this;
var _37356__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37354(self__.opts,self__.id,self__.fn_to_element,meta37355__$1));
}));

(reagent.impl.template.t_reagent$impl$template37354.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37356){
var self__ = this;
var _37356__$1 = this;
return self__.meta37355;
}));

(reagent.impl.template.t_reagent$impl$template37354.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37354.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37354.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37354.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37354.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta37355","meta37355",910490531,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37354.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37354.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37354");

(reagent.impl.template.t_reagent$impl$template37354.cljs$lang$ctorPrWriter = (function (this__4404__auto__,writer__4405__auto__,opt__4406__auto__){
return cljs.core._write(writer__4405__auto__,"reagent.impl.template/t_reagent$impl$template37354");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37354.
 */
reagent.impl.template.__GT_t_reagent$impl$template37354 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37354(opts__$1,id__$1,fn_to_element__$1,meta37355){
return (new reagent.impl.template.t_reagent$impl$template37354(opts__$1,id__$1,fn_to_element__$1,meta37355));
});

}

return (new reagent.impl.template.t_reagent$impl$template37354(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
