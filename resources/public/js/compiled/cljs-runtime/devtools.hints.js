...
}catch (e26903){var _e = e26903;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___26966 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___26966)){
var seen_errors_26967 = temp__5733__auto___26966;
if(cljs.core.truth_(seen_errors_26967.has(self))){
} else {
seen_errors_26967.add(self);

var temp__5735__auto___26969 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___26969)){
var sense_26970 = temp__5735__auto___26969;
